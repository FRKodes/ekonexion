		...
		<div class="list-group col-md-10 col-md-offset-1">
			@foreach($negocios as $negocio)
				<div class="list-group-item container-fluid">
					<div class="col-xs-10 nombre"><a class="verde2" href="/admin/negocios/{{ $negocio->id }}/edit" title="Ver el detalle de {{ $negocio->nombre_negocio }}">{{ $negocio->nombre_negocio }}</a></div>
