...
@section('titlePage', 'Agregar Evento')
	...
	<div class="container-fluid">
			<div class="row">
				<div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
					...
					<h1 class="handlee text-center verde2">Agregar un evento</h1>

					@if ($errors->any())
						<div class="alert alert-danger">
							<p class="text-center">Hubo un problema al agregar el evento.<br><br></p>
							<ul>
					...
					{!! Form::open(['class'=>'form-horizontal', 'role'=>'form', 'url'=>'admin/eventos', 'id'=>'EventosForm', 'files'=>true]) !!}
						...
						<div class="form-group"><input type="text" class="form-control" name="descripction" placeholder="descripción" value></div>
						<div class="form-group"><input type="text" class="form-control" name="link" placeholder="http://" value ></div>
						<div class="form-group"><input type="text" class="form-control" name="date" placeholder="Fecha" value ></div>
